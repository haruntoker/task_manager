        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          ...
          <div className="flex items-center gap-2 pl-2 md:pl-3 border-l border-border">
            <Avatar className="w-7 h-7 md:w-8 md:h-8 ring-2 ring-primary/20 transition-all duration-300 hover:ring-primary/40">
              <AvatarImage src="/profile.jpg" alt="Harun Toker" />
              <AvatarFallback className="text-xs">JS</AvatarFallback>
            </Avatar>
            <div className="text-xs hidden sm:block">
              <p className="font-semibold text-foreground">Harun Toker</p>
              <p className="text-muted-foreground text-[10px]">harundev.com</p>
            </div>
          </div>
        </div>
      </div>
